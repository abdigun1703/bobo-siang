...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function() {
        Route::middleware('can:manage cities')->group(function() { // pasang disini, untuk user walaupun sudah login, tapi tidak memiliki permission untuk manage cities, tidak akan bia masuk
            Route::resource('/cities', CityController::class);
        });

        Route::middleware('can:manage countries')->group(function() { // pasang disini, untuk user walaupun sudah login, tapi tidak memiliki permission untuk manage cities, tidak akan bia masuk
            Route::resource('/countries', CountryController::class);
        });

        Route::middleware('can:manage hotels')->group(function() { // pasang disini, untuk user walaupun sudah login, tapi tidak memiliki permission untuk manage cities, tidak akan bia masuk
