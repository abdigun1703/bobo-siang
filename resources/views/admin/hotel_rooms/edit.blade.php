            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg">
                ...
                <form method="POST" action="{{ route('admin.hotel_rooms.update', $hotelRoom) }}" enctype="multipart/form-data"> 
                    ...
                    <div class="mt-4">
                        ...
                        <img src="{{ Storage::url($hotelRoom->photo) }}" alt="" class="rounded-2xl object-cover w-[120px] h-[90px]" style="width: 120px; height: 90px;" />
                    ...
                    <div class="flex items-center justify-end mt-4">
                        ...
                        <button type="submit" class="text-sm text-gray-600 dark:text-gray-400">
                            Add New Hotel Room
                        </button>
                    </div>
                </form>
