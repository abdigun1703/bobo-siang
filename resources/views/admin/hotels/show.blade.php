        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="item-card flex flex-row justify-between items-center">
                    ...
                    <div class="md:flex flex-column items-center gap-x-3">
                        <a href="{{ route('admin.hotels.edit', $hotel) }}" class="font-bold py-4 px-6 bg-indigo-700 text-slate-500 rounded-full">
                            Edit
                        </a>
                ...
                <div class="flex flex-row gap-x-5"> 
                    @foreach($latestPhotos as $photo)
                        <img src="{{ Storage::url($photo->photo) }}" alt="" class="rounded-2xl object-cover w-[120px] h-[90px]" style="width: 100px; height: 80px;"  />
                    @endforeach
                </div>
                ...
                <div class="flex flex-row justify-between items-center">
                    ...
                    <a href="{{ route('admin.hotel_rooms.create', $hotel->slug) }}" class="font-bold py-4 px-6 bg-indigo-700 text-slate-500 rounded-full">
                        Add New Room
                    </a>
                </div>
                ...
                <div class="item-card flex flex-row justify-between items-center">
                    <div class="flex flex-row items-center gap-x-3">
                        <img src="{{ Storage::url($room->photo) }}" alt="" class="rounded-2xl object-cover w-[120px] h-[90px]" style="width: 120px; height: 90px;" />
                        <div class="flex flex-col">
                            <h3 class="text-indigo-950 text-xl font-bold">
                                {{ $room->name }}
                            </h3>
                    ...
                    <div class="md:flex flex-row items-center gap-x-3">
                        <a href="{{ route('admin.hotel_rooms.edit', [$hotel->slug, $room]) }}" class="font-bold py-4 px-6 bg-indigo-700 text-slate-500 rounded-full">
                            Edit
                        </a>
                ...
                @empty
                <div>Maaf tidak ada data yang lainnya</div>
                @endforelse
