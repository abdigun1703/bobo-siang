<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg" style="padding: 15px;"> 
                <form method="POST" action="{{ route('admin.hotels.store') }}" enctype="multipart/form-data"> 
                    ...
                    <div class="flex items-center justify-end mt-4">
                        ...
                        <button type="submit" class="font-bold py-4 px-6 bg-indigo-700 text-gray-500 rounded-full">
                            Add New Hotel
                        </button>
                    </div>
                </form>
