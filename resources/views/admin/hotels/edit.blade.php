            ...
            <div class="bg-white overflow-hidden p-10 shadow-sm sm:rounded-lg"> 
                ...
                <form method="POST" action="{{ route('admin.hotels.update', $hotel) }}" enctype="multipart/form-data"> 
                    ...
                    <div class="mt-4">
                        ...
                        <img src="{{ Storage::url($hotel->thumbnail) }}" alt="" class="rounded-2xl object-cover w-[120px] h-[90px]" style="width: 100px; height: 80px;"  />
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input value="{{$hotel->link_gmaps}}" id="link_gmaps" class="block mt-1 w-full" type="text" name="link_gmaps" 
                    ...
                    <div class="mt-4">
                        ...
                        <x-text-input value="{{$hotel->star_level}}" id="star_level" class="block mt-1 w-full" type="number" name="star_level"  required autofocus autocomplete="star_level" />
                        <x-input-error :messages="$errors->get('star_level')" class="mt-2" />
                    </div>

                    <hr class="my-5"> 
                        @foreach($latestPhotos as $photos)
                        <div class="mt-4">
                            <x-input-label for="photo" :value="__('photo')" />
                            <img src="{{ Storage::url($photos->photo) }}" alt="" class="rounded-2xl object-cover w-[120px] h-[90px]" style="width: 90px; height: 70px;" />
                    ...
                    <div class="flex items-center justify-end mt-4">
                        ...
                        <button type="submit" class="font-bold py-4 px-6 bg-indigo-700 text-indigo-950 rounded-full">
                            Update Hotel
                        </button>
                    </div>
                </form>
