      ...
      <div id="result" class="result-card-container flex flex-col gap-[18px]">
        ...
        <div class="card-result bg-white rounded-xl overflow-hidden flex flex-col">
          ...
          <div class="content-container flex flex-col p-4 gap-4">
            <div class="title-container flex flex-col gap-[2px]">
              ...
              <p class="font-medium text-sm leading-[21px] text-[#757C98]">Max.{{ $room->max_people }} Adult /Room</p>
            </div>
            ...
            <div class="price-container flex items-center justify-between">
              ...
              <form  method="POST" action="{{ route('front.hotel.room.book', [$hotel->slug, $room->id]) }}">
                ...
                <button type="submit" class="w-[138px] h-[48px] bg-[#4041DA] p-[12px_24px] rounded-full text-nowrap text-white font-semibold text-sm leading-[21px] flex items-center justify-center">
                    Choose
                </button>
              </form>
            </div>
        ...
        @empty
          <div id="result" class="result-card-container flex flex-col gap-[18px]">
              ...
              <p class="font-medium text-[#757C98] text-center">Sadly, it looks like no rooms available</p>
              </div>
          </div>
        @endforelse
